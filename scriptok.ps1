...
$Global:RemoteServer = ""
$Global:SSHUsername = ""
$Global:SSHPassword = $null  # Will store SecureString
$Global:LogFilePath = "/var/log/AdminTools.log"
...
function Test-SSHConnection {
    ...
    try {
        $result = Test-NetConnection -ComputerName $ComputerName -Port 22
        if ($result.TcpTestSucceeded) {
            # Test connection with credentials
            $cmd = "echo 'Test Connection'"
            $result = & ssh $Username@$ComputerName $cmd
            return $true
        }
        [System.Windows.Forms.MessageBox]::Show("Erreur: Port SSH fermé sur $ComputerName", "Erreur")
        return $false
    } catch {
        [System.Windows.Forms.MessageBox]::Show("Erreur SSH: $_", "Erreur")
        return $false
    }
}

# Modified remote command execution
function Invoke-RemoteCommand {
    param(
        [string]$Command
    )
    try {
        $result = & ssh "$($Global:SSHUsername)@$($Global:RemoteServer)" $Command
        return $result
    } catch {
        [System.Windows.Forms.MessageBox]::Show("Erreur commande distante: $_", "Erreur")
        return $null
    }
}
...
function Log-Action {
    ...
    Invoke-RemoteCommand "echo '$logMessage' >> $Global:LogFilePath"
}

# Modified Computer Selection Form
function Show-ComputerSelection {
    ...
    $lblUsername.Location = New-Object System.Drawing.Point(10, 50)
    $selectForm.Controls.Add($lblUsername)

    $txtUsername = New-Object System.Windows.Forms.TextBox
    $txtUsername.Location = New-Object System.Drawing.Point(120, 50)
    $txtUsername.Size = New-Object System.Drawing.Size(250, 20)
    $selectForm.Controls.Add($txtUsername)

    $lblPassword = New-Object System.Windows.Forms.Label
    $lblPassword.Text = "Mot de passe:"
    $lblPassword.Location = New-Object System.Drawing.Point(10, 80)
    $selectForm.Controls.Add($lblPassword)

    $txtPassword = New-Object System.Windows.Forms.MaskedTextBox
    $txtPassword.PasswordChar = '*'
    $txtPassword.Location = New-Object System.Drawing.Point(120, 80)
    $txtPassword.Size = New-Object System.Drawing.Size(250, 20)
    $selectForm.Controls.Add($txtPassword)

    $btnConnect = New-Object System.Windows.Forms.Button
    $btnConnect.Text = "Connecter"
    $btnConnect.Location = New-Object System.Drawing.Point(150, 120)
    $btnConnect.Add_Click({
        if (Test-SSHConnection $txtComputer.Text $txtUsername.Text $txtPassword.Text) {
            $Global:RemoteServer = $txtComputer.Text
            $Global:SSHUsername = $txtUsername.Text
            $Global:SSHPassword = $txtPassword.Text | ConvertTo-SecureString -AsPlainText -Force
